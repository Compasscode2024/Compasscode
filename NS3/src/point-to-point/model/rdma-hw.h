...
public:
	...
	/*
		power tcp
	*/
	double NormPower(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader &ch);
	void HandleAckPowertcp(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader &ch);
	void HandleAckPw(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader &ch);
	void UpdateRatePw(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader &ch, bool fast_react);
	void FastReactPw(Ptr<RdmaQueuePair> qp, Ptr<Packet> p, CustomHeader &ch);
